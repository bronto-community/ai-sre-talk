...
export const DOMAINS: Domain[] = [
  ...
  },
  {
    ...
    cells: {
      ...
      linear:      'High load → add one / double; low load → reverse.',
  ...
  },
  {
    ...
    cells: {
      ...
      conditional: 'If precursor conditions match → auto-mitigate.',
      high:        'Models detect anomalies / precursors early.',
  ...
  },
  {
    ...
    cells: {
      ...
      linear:      'Alerting → human notified → basic script responds.',
      conditional: 'Alerting → if conditions met, auto-remediate.',
